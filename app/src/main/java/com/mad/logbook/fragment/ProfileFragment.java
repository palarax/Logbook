 ...
 * @date 10-Sep-17
 */
public class ProfileFragment extends Fragment implements BackendlessPresenter.HandleResponse {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final TextView mDobText = view.findViewById(R.id.txt_dob);  //TODO: get correct format
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mProgress.show();
                mBackendlessPresenter.updateBackendlessUser(mUserPresenter.getStudent(), Backendless.UserService.CurrentUser(), nameEdit.getText().toString(),
